...
def func1():
    ...
    driver.find_element_by_xpath("//tbody/tr[65]/td/form/input[@value='View Sections']").click()
    driver.implicitly_wait(10) #440 = 36, 412 = 24

    while True:
            driver.implicitly_wait(6)
            try:
                shit1=driver.find_element_by_xpath("//input[@value='69131 120198']")
                ...
                driver.implicitly_wait(10)
                driver.find_element_by_id("crn_id1").send_keys('69131')
                driver.find_element_by_xpath("//input[@value='Submit Changes']").click()
                break
            except NoSuchElementException:
                try:
