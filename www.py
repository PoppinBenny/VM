...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('siqi4')
    driver.find_element_by_id("easpass").send_keys('www.SQ.www')
    ...
    while True:
        if switch%2==0:
            ...
            try:
                ...
                shit2=driver.find_element_by_xpath("//input[@value='63740 120198']")
                shit1.click()
                shit2.click()
        ...
        if switch%2==1:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='64513 120198']")
                shit2=driver.find_element_by_xpath("//input[@value='64548 120198']")
                shit1.click()
                shit2.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
