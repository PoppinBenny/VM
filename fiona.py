...
def drop_mode(crn,drop):
    global register
    shit1=driver.find_element_by_xpath("//input[@value='"+crn+" 120201']")
    shit2=driver.find_element_by_xpath("//input[@value='68830 120201']")
    driver.find_element_by_xpath("//input[@value='Register']").click()
    driver.implicitly_wait(7.5)
    find_drop(drop)
    find_drop('50326')
    ...
    driver.find_element_by_id("crn_id2").send_keys('68830')
    driver.find_element_by_xpath("//input[@value='Submit Changes']").click()
    driver.implicitly_wait(10)
    i=2
    try:
        ...
        driver.find_element_by_id("crn_id2").send_keys('50326')
        driver.find_element_by_xpath("//input[@value='Submit Changes']").click()
        driver.implicitly_wait(10)
        register+=1
        if register>=limit:
