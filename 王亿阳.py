...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('yiyangw4')
    driver.find_element_by_id("easpass").send_keys("Dd778899")
    ...
    while True:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='69973 120198']")
                ...
                driver.implicitly_wait(10)
                driver.find_element_by_id("crn_id1").send_keys('69973')
                driver.find_element_by_xpath("//input[@value='Submit Changes']").click()
                break
            except NoSuchElementException:
                try:
