...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('xiangxi2')
    driver.find_element_by_id("easpass").send_keys('Keyijinsida12')
    ...
    while True:
        ...
        try:
            shit1=driver.find_element_by_xpath("//input[@value='59390 120188']")
            ...
            driver.back()
            driver.find_element_by_xpath("//tbody/tr[20]/td/form/input[@value='View Sections']").click()
            driver.find_element_by_xpath("//input[@value='59390 120188']").click()
            driver.find_element_by_xpath("//input[@value='Register']").click()
            break
