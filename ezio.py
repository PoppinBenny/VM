...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('yaoxiao9')
    driver.find_element_by_id("easpass").send_keys("XY19960218@uiuc")
    ...
    while True:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='57769 120198']")
                shit1.click()
