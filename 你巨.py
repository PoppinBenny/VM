...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('yijiaz3')
    driver.find_element_by_id("easpass").send_keys('Woshi18261564476!!')
    ...
    while True:
        if switch%2==0:
            ...
            try:
                ...
                try:
                    ...
                    driver.find_element_by_xpath("//input[@value='Submit']").click()
                    driver.implicitly_wait(10)
                    driver.find_element_by_xpath("//option[@value='ART']").click()
                    driver.find_element_by_xpath("//input[@value='Course Search']").click()
                    driver.implicitly_wait(10)
        ...
        if switch%2==1:
            driver.implicitly_wait(3)
            try:
                shit1=driver.find_element_by_xpath("//input[@value='64967 120188']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
