...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('yuwenc2')
    driver.find_element_by_id("easpass").send_keys('Cyw137955')
    ...
    while True:
        if switch%2==0:
            ...
            try:
                shit3=driver.find_element_by_xpath("//input[@value='70549 120198']")
                shit3.click()
