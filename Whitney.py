...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('mliu78')
    driver.find_element_by_id("easpass").send_keys('Dionna860718')
    ...
    while True:
        driver.implicitly_wait(7.5)
        try:
            shit1=driver.find_element_by_xpath("//input[@value='29649 120188']")
            shit1.click()
