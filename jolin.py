...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('linz4')
    driver.find_element_by_id("easpass").send_keys('Zl19970223#')
    ...
    while True:
        ...
        if switch%3==1:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='68770 120198']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
