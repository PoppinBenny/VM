...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('zidank2')
    driver.find_element_by_id("easpass").send_keys('Kzd12345.')
    ...
    while True:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='65865 120191']")
                shit1.click()
