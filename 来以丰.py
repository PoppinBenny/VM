...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('yifengl2')
    driver.find_element_by_id("easpass").send_keys('Xdf2018@offer')
    ...
    while True:
            ...
            try:
                shit3=driver.find_element_by_xpath("//input[@value='63422 120191']")
