...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('yunyey2')
    driver.find_element_by_id("easpass").send_keys('Christineyang1996')
    ...
    while True:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='70222 120198']")
                ...
                driver.implicitly_wait(10)
                driver.find_element_by_id("crn_id1").send_keys('70222')
                driver.find_element_by_xpath("//input[@value='Submit Changes']").click()
                break
            except NoSuchElementException:
                try:
