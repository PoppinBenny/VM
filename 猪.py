...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('jingnan5')
    driver.find_element_by_id("easpass").send_keys('991120Asdf!')
    ...
    while True:
        if switch%2==0:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='40091 120198']")
                shit1.click()
        ...
        if switch%2==1:
            driver.implicitly_wait(3)
            try:
                shit1=driver.find_element_by_xpath("//input[@value='54837 120198']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
