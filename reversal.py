...
major=['PHYS']
xuhao=['213']
disc=[30276,30277,30278,39133,40750,40775]
lab=[30279,30280,30281,39135,40751,40776]
...
def normal(crn1,crn2):
    global register
    shit1=driver.find_element_by_xpath("//input[@value='"+crn1+" 120205']")
    shit2=driver.find_element_by_xpath("//input[@value='"+crn2+" 120205']")
    shit3=driver.find_element_by_xpath("//input[@value='30275 120205']")
    shit2.click()
    shit1.click()
    shit3.click()
