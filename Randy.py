...
def func1():
    ...
    while True:
        if switch%6==0:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='35879 120188']")
                shit2=driver.find_element_by_xpath("//input[@value='35915 120188']")
                shit1.click()
                shit2.click()
        ...
        if switch%6==1:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='35879 120188']")
                shit2=driver.find_element_by_xpath("//input[@value='35902 120188']")
                shit1.click()
                shit2.click()
                break
            except NoSuchElementException:
        ...
        if switch%6==2:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='35879 120188']")
                shit2=driver.find_element_by_xpath("//input[@value='35899 120188']")
                shit1.click()
                shit2.click()
                break
            except NoSuchElementException:
        ...
        if switch%6==3:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='35879 120188']")
                shit2=driver.find_element_by_xpath("//input[@value='35913 120188']")
                shit1.click()
                shit2.click()
                break
            except NoSuchElementException:
        ...
        if switch%6==4:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='35879 120188']")
                shit2=driver.find_element_by_xpath("//input[@value='35910 120188']")
                shit1.click()
                shit2.click()
                break
            except NoSuchElementException:
        ...
        if switch%6==5:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='35879 120188']")
                shit2=driver.find_element_by_xpath("//input[@value='35918 120188']")
                shit1.click()
                shit2.click()
                break
            except NoSuchElementException:
