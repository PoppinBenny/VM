...
def func1():
    ...
    while True:
        ...
        if switch%12==2:
            driver.implicitly_wait(0.5)
            try:
                shit1=driver.find_element_by_xpath("//input[@value='68127 120198']")
                shit2=driver.find_element_by_xpath("//input[@value='68193 120198']")
                shit1.click()
                shit2.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
        ...
        if switch%12==3:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='68127 120198']")
                shit2=driver.find_element_by_xpath("//input[@value='68185 120198']")
                shit1.click()
                shit2.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
        ...
        if switch%12==4:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='68127 120198']")
                shit2=driver.find_element_by_xpath("//input[@value='68190 120198']")
                shit1.click()
                shit2.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
        ...
        if switch%12==5:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='68127 120198']")
                shit2=driver.find_element_by_xpath("//input[@value='68183 120198']")
                shit1.click()
                shit2.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
