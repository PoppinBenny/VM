...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('yiyangy2')
    driver.find_element_by_id("easpass").send_keys("Dea$thek1d")
    ...
    while True:
        if switch%2==0:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='42812 120188']")
                shit1.click()
        ...
        if switch%2==1:
            driver.implicitly_wait(2.5)
            try:
                shit1=driver.find_element_by_xpath("//input[@value='59389 120188']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
