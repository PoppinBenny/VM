...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('keweiz2')
    driver.find_element_by_id("easpass").send_keys("Weikezhou980810")
    ...
    while True:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='63553 120191']")
                shit1.click()
