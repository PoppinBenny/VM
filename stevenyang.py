...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('fyyang2')
    driver.find_element_by_id("easpass").send_keys("76852813Abcd")
    ...
    while True:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='64013 120201']")
                shit1.click()
