...
def func1():
    ...
    driver.implicitly_wait(10)
    driver.find_element_by_xpath("//option[@value='ARTH']").click()
    ...
    while True:
        if switch%2==0:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='69273 120191']")
                ...
                driver.back()
                driver.find_element_by_xpath("//tbody/tr[5]/td/form/input[@value='View Sections']").click()
                driver.find_element_by_xpath("//input[@value='69273 120191']").click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
