...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('xy10')
    driver.find_element_by_id("easpass").send_keys("Cnm00005")
    ...
    while True:
        if switch%3==0:
            ...
            try:
                ...
                driver.back()
                driver.find_element_by_xpath("//tbody/tr[14]/td/form/input[@value='View Sections']").click()
                driver.find_element_by_xpath("//input[@value='69351 120191']").click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
        ...
        if switch%3==1:
            ...
            try:
                ...
                driver.back()
                driver.find_element_by_xpath("//tbody/tr[16]/td/form/input[@value='View Sections']").click()
                driver.find_element_by_xpath("//input[@value='50354 120191']").click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
                try:
        ...
        if switch%3==2:
            ...
            try:
                ...
                driver.back()
                driver.find_element_by_xpath("//tbody/tr[16]/td/form/input[@value='View Sections']").click()
                driver.find_element_by_xpath("//input[@value='61877 120191']").click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
                try:
