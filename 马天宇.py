...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('tianyum2')
    driver.find_element_by_id("easpass").send_keys('19981105Mty')
    ...
    while True:
        ...
        if switch%6==1:
            driver.implicitly_wait(1)
            try:
                shit1=driver.find_element_by_xpath("//input[@value='70215 120198']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
        ...
        if switch%6==3:
            driver.implicitly_wait(1)
            try:
                shit1=driver.find_element_by_xpath("//input[@value='71666 120198']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
