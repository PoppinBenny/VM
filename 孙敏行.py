...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('minxing2')
    driver.find_element_by_id("easpass").send_keys("Wys10060914!")
    ...
    while True:
        if switch%2==0:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='31722 120198']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
                try:
                    print('no 99 yet, trying again....')
                    switch+=1
                except NoSuchElementException:
                    time.sleep(30)
                    driver.close()
        ...
        if switch%2==1:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='57719 120198']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
