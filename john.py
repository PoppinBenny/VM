...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('weipeng5')
    driver.find_element_by_id("easpass").send_keys('Wwp@135246')
    ...
    while True:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='37829 120191']")
                shit1.click()
