...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('xiangy2')
    driver.find_element_by_id("easpass").send_keys('XiaoxuLaoqian0302!!!')
    ...
    while True:
        if switch%2==0:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='56186 120191']")
                shit1.click()
        ...
        if switch%2==1:
            driver.implicitly_wait(3)
            try:
                shit1=driver.find_element_by_xpath("//input[@value='33948 120191']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
