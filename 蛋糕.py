...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('yudaj2')
    driver.find_element_by_id("easpass").send_keys('AAa19980901@!!')
    ...
    while True:
        ...
        try:
            ...
            driver.back()
            driver.find_element_by_xpath("//tbody/tr[13]/td/form/input[@value='View Sections']").click()
            driver.find_element_by_xpath("//input[@value='62029 120188']").click()
            driver.find_element_by_xpath("//input[@value='Register']").click()
            break
