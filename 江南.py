...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('lanj2')
    driver.find_element_by_id("easpass").send_keys("9903277MIcind")
    ...
    while True:
        ...
        if switch%3==2:
            ...
            try:
                ...
                driver.find_element_by_xpath("//input[@value='Submit Changes']").click()
                driver.implicitly_wait(10)
                driver.find_element_by_id("crn_id1").send_keys('68358')
                driver.find_element_by_xpath("//input[@value='Submit Changes']").click()
                break
            except NoSuchElementException:
                try:
