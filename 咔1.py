...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('rni4')
    driver.find_element_by_id("easpass").send_keys('Nixin110828')
    ...
    while True:
            ...
            try:
                ...
                shit2=driver.find_element_by_xpath("//input[@value='63734 120198']")
                shit1.click()
                shit2.click()
