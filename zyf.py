...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('yifeiz4')
    driver.find_element_by_id("easpass").send_keys("Maozhao1999")
    ...
    while True:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='49255 120198']")
                ...
                driver.implicitly_wait(10)
                driver.find_element_by_id("crn_id1").send_keys('49255')
                driver.find_element_by_xpath("//input[@value='Submit Changes']").click()
                break
            except NoSuchElementException:
                try:
