...
def drop_mode(crn,drop):
    shit1=driver.find_element_by_xpath("//input[@value='31168 120201']")
    ...
    driver.implicitly_wait(10)
    driver.find_element_by_id("crn_id1").send_keys('31168')
    driver.find_element_by_id("crn_id2").send_keys(crn)
    driver.find_element_by_xpath("//input[@value='Submit Changes']").click()
