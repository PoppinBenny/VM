...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('cp10')
    driver.find_element_by_id("easpass").send_keys('Xzz318427')
    ...
    while True:
        if switch%4==0:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='36195 120191']")
                shit1.click()
        ...
        if switch%4==2:
            driver.implicitly_wait(1.5)
            try:
                shit1=driver.find_element_by_xpath("//input[@value='63552 120191']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
        ...
        if switch%4==3:
            driver.implicitly_wait(1.5)
            try:
                shit1=driver.find_element_by_xpath("//input[@value='68734 120191']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
