...
def func1():
    ...
    driver.find_element_by_id("easpass").send_keys('Claussun0729')
    ...
    driver.implicitly_wait(10)
    driver.find_element_by_xpath("//option[@value='TSM']").click()
    ...
    while True:
        if switch%4==0:
            ...
            try:
                ...
                shit2=driver.find_element_by_xpath("//input[@value='66568 120191']")
                shit1.click()
                shit2.click()
        ...
        if switch%4==1:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='44662 120191']")
                shit2=driver.find_element_by_xpath("//input[@value='57736 120191']")
                shit1.click()
                shit2.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
