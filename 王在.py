...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('zaitian3')
    driver.find_element_by_id("easpass").send_keys("RDFZDanielWang2029")
    ...
    while True:
        if switch%2==0:
            ...
            try:
                ...
                try:
                    ...
                    driver.find_element_by_xpath("//input[@value='Course Search']").click()
                    driver.implicitly_wait(10)
                    driver.find_element_by_xpath("//tbody/tr[48]/td/form/input[@value='View Sections']").click()
                except NoSuchElementException:
                    time.sleep(30)
                    driver.close()
                    func1()
        if switch%2==1:
            driver.implicitly_wait(3)
            try:
                shit1=driver.find_element_by_xpath("//input[@value='58799 120198']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
