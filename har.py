...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('yinuolu2')
    driver.find_element_by_id("easpass").send_keys("SzHr003468")
    ...
    driver.implicitly_wait(10)
    driver.find_element_by_xpath("//option[@value='CLHL']").click()
    ...
    while True:
            ...
            try:
                ...
                driver.implicitly_wait(10)
                driver.find_element_by_id("crn_id1").send_keys('57350')
                driver.find_element_by_xpath("//input[@value='Submit Changes']").click()
                break
            except NoSuchElementException:
                try:
