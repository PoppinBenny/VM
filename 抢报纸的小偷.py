...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('jialiux2')
    driver.find_element_by_id("easpass").send_keys('Xiejl8888')
    ...
    while True:
            ...
            try:
                ...
                driver.back()
                driver.find_element_by_xpath("//tbody/tr[22]/td/form/input[@value='View Sections']").click()
                driver.find_element_by_xpath("//input[@value='65106 120188']").click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
