...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('hl19')
    driver.find_element_by_id("easpass").send_keys("Neo990112")
    ...
    while True:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='41268 120198']")
                ...
                driver.implicitly_wait(10)
                driver.find_element_by_id("crn_id1").send_keys('41268')
                driver.find_element_by_xpath("//input[@value='Submit Changes']").click()
                break
            except NoSuchElementException:
                try:
