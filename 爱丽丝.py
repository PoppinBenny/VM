...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('yaox3')
    driver.find_element_by_id("easpass").send_keys("7758251Lisa")
    ...
    while True:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='71775 120198']")
                shit1.click()
