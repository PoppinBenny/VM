...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('yixic2')
    driver.find_element_by_id("easpass").send_keys('A1s2d3f4%')
    ...
    while True:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='31333 120198']")
                ...
                driver.implicitly_wait(10)
                driver.find_element_by_id("crn_id1").send_keys('31333')
                driver.find_element_by_xpath("//input[@value='Submit Changes']").click()
                break
            except NoSuchElementException:
                try:
                    print('no 32 yet, trying again....')
                    driver.back()
                    driver.find_element_by_xpath("//tbody/tr[12]/td/form/input[@value='View Sections']").click()
                except NoSuchElementException:
                    time.sleep(30)
