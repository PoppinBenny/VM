...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('ruim2')
    driver.find_element_by_id("easpass").send_keys("MRqq7244033*")
    ...
    while True:
        ...
        if switch%2==1:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='72280 120198']")
                shit2=driver.find_element_by_xpath("//input[@value='63146 120198']")
                shit1.click()
                shit2.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
