...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('chuhan2')
    driver.find_element_by_id("easpass").send_keys(" Huch390972@19991012")
    ...
    while True:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='65589 120198']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
                try:
                    print('no 55 yet, trying again....')
                    driver.back()
                    driver.find_element_by_xpath("//tbody/tr[4]/td/form/input[@value='View Sections']").click()
                except NoSuchElementException:
                    time.sleep(30)
