...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('yz11')
    driver.find_element_by_id("easpass").send_keys('Zhangyuge1998zyll')
    ...
    while True:
        ...
        try:
            shit1=driver.find_element_by_xpath("//input[@value='31247 120191']")
            ...
            driver.back()
            driver.find_element_by_xpath("//tbody/tr[52]/td/form/input[@value='View Sections']").click()
            driver.find_element_by_xpath("//input[@value='31247 120191']").click()
            driver.find_element_by_xpath("//input[@value='Register']").click()
            break
