...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('quanyuz2')
    driver.find_element_by_id("easpass").send_keys("Alstar769804544.")
    ...
    while True:
        if switch%2==0:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='31292 120198']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
                try:
                    print('no 96 yet, trying again....')
                    switch+=1
                except NoSuchElementException:
                    time.sleep(30)
                    driver.close()
        ...
        if switch%2==1:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='52475 120198']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
