...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('gxu12')
    driver.find_element_by_id("easpass").send_keys('Xgy1996C')
    ...
    while True:
        driver.implicitly_wait(7.5)
        try:
            shit1=driver.find_element_by_xpath("//input[@value='70250 120188']")
            shit1.click()
