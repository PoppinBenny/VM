...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('zheyu3')
    driver.find_element_by_id("easpass").send_keys('19981225zzY!')
    ...
    while True:
        ...
        if switch%6==1:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='39311 120191']")
                shit2=driver.find_element_by_xpath("//input[@value='48263 120191']")
                shit1.click()
                shit2.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
