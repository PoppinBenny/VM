...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('peiyunz2')
    driver.find_element_by_id("easpass").send_keys('Kester&1005')
    ...
    while True:
        driver.implicitly_wait(5)
        try:
            shit1=driver.find_element_by_xpath("//input[@value='35917 120188']")
            shit2=driver.find_element_by_xpath("//input[@value='35956 120188']")
            shit1.click()
            shit2.click()
