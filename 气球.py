...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('yitianh2')
    driver.find_element_by_id("easpass").send_keys('Yt@19710201')
    ...
    while True:
        driver.implicitly_wait(5)
        try:
            shit1=driver.find_element_by_xpath("//input[@value='58275 120188']")
            shit1.click()
