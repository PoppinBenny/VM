...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('jhe39')
    driver.find_element_by_id("easpass").send_keys("Hejc441231")
    ...
    while True:
        ...
        if switch%3==1:
            ...
            try:
                ...
                try:
                    ...
                    driver.find_element_by_xpath("//input[@value='Submit']").click()
                    driver.implicitly_wait(10)
                    driver.find_element_by_xpath("//option[@value='PS']").click()
                    driver.find_element_by_xpath("//input[@value='Course Search']").click()
                    driver.implicitly_wait(10)
        ...
        if switch%3==2:
            driver.implicitly_wait(2)
            try:
                shit1=driver.find_element_by_xpath("//input[@value='72397 120198']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
