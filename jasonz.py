...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('jz46')
    driver.find_element_by_id("easpass").send_keys('QWEasdzxc123')
    ...
    while True:
        if switch%3==0:
            ...
            try:
                shit3=driver.find_element_by_xpath("//input[@value='40083 120198']")
        ...
        if switch%3==1:
            ...
            try:
                shit3=driver.find_element_by_xpath("//input[@value='40083 120198']")
                shit2=driver.find_element_by_xpath("//input[@value='71539 120198']")
                shit3.click()
                shit2.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
        ...
        if switch%3==2:
            driver.implicitly_wait(0.5)
            try:
                shit3=driver.find_element_by_xpath("//input[@value='30102 120198']")
