...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('ruobinw2')
    driver.find_element_by_id("easpass").send_keys("QAQqwqQAQ233")
    ...
    while True:
            ...
            try:
                shit3=driver.find_element_by_xpath("//input[@value='55638 120191']")
