...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('yiruil2')
    driver.find_element_by_id("easpass").send_keys("Jason123456!")
    ...
    while True:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='33998 120198']")
                shit1.click()
