...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('yimingc3')
    driver.find_element_by_id("easpass").send_keys("1197748241Dominator")
    ...
    while True:
        if switch%2==0:
            ...
            try:
                ...
                driver.implicitly_wait(10)
                driver.find_element_by_id("crn_id1").send_keys('30102')
                driver.find_element_by_id("crn_id1").send_keys('63145')
                driver.find_element_by_xpath("//input[@value='Submit Changes']").click()
                break
            except NoSuchElementException:
                try:
