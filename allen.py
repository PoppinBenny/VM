...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('fanzang2')
    driver.find_element_by_id("easpass").send_keys("W7kkfsga0314")
    ...
    while True:
        if switch%5==0:
            ...
            try:
                ...
                shit2=driver.find_element_by_xpath("//input[@value='51495 120198']")
                shit1.click()
                shit2.click()
        ...
        if switch%5==4:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='40083 120198']")
                shit2=driver.find_element_by_xpath("//input[@value='63144 120198']")
                shit1.click()
                shit2.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
