...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('tianyim4')
    driver.find_element_by_id("easpass").send_keys('Allen980831mty980831')
    ...
    while True:
        if switch%3==0:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='68005 120191']")
                shit1.click()
        ...
        if switch%3==1:
            driver.implicitly_wait(2)
            try:
                shit1=driver.find_element_by_xpath("//input[@value='40462 120191']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
        ...
        if switch%3==2:
            driver.implicitly_wait(2)
            try:
                shit1=driver.find_element_by_xpath("//input[@value='60004 120191']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
