...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('langlei2')
    driver.find_element_by_id("easpass").send_keys("875370932Ll-")
    ...
    while True:
        if switch%3==0:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='46795 120198']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
                try:
                    print('no 70 yet, trying again....')
                    switch+=1
                except NoSuchElementException:
                    time.sleep(30)
                    driver.close()
        ...
        if switch%3==1:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='38006 120198']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
        ...
        if switch%3==2:
            driver.implicitly_wait(0.5)
            try:
                shit1=driver.find_element_by_xpath("//input[@value='37995 120198']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
