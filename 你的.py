...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('xinyis2')
    driver.find_element_by_id("easpass").send_keys("SHmc981017")
    ...
    while True:
            ...
            try:
                ...
                driver.implicitly_wait(10)
                driver.find_element_by_id("crn_id1").send_keys('70812')
                driver.find_element_by_xpath("//input[@value='Submit Changes']").click()
                break
            except NoSuchElementException:
                try:
