...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('chenxie3')
    driver.find_element_by_id("easpass").send_keys('Xccyp225')
    ...
    while True:
            ...
            try:
                ...
                driver.back()
                driver.find_element_by_xpath("//tbody/tr[21]/td/form/input[@value='View Sections']").click()
                driver.find_element_by_xpath("//input[@value='67117 120191']").click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
