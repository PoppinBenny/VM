...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('maolinw2')
    driver.find_element_by_id("easpass").send_keys('Hkust1328')
    ...
    while True:
            ...
            try:
                shit3=driver.find_element_by_xpath("//input[@value='"+str(sections[switch%3])+" 120198']")
                shit3.click()
