...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('shaokef2')
    driver.find_element_by_id("easpass").send_keys('Fsk19971019?')
    ...
    while True:
        if switch%2==0:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='66601 120188']")
                ...
                driver.back()
                driver.find_element_by_xpath("//tbody/tr[21]/td/form/input[@value='View Sections']").click()
                driver.find_element_by_xpath("//input[@value='66601 120188']").click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
        ...
        if switch%2==1:
            driver.implicitly_wait(3.75)
            try:
                shit1=driver.find_element_by_xpath("//input[@value='70826 120188']")
                driver.find_element_by_xpath("//input[@value='Register']").click()
                driver.implicitly_wait(7.5)
