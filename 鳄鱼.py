...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('zz18')
    driver.find_element_by_id("easpass").send_keys("ZZY19981218zzy---")
    ...
    while True:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='72084 120198']")
                ...
                driver.implicitly_wait(10)
                driver.find_element_by_id("crn_id1").send_keys('72084')
                driver.find_element_by_xpath("//input[@value='Submit Changes']").click()
                break
            except NoSuchElementException:
                try:
