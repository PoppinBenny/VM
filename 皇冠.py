...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('nleng2')
    driver.find_element_by_id("easpass").send_keys('9990219Lna29')
    ...
    while True:
        ...
        if switch%2==1:
            driver.implicitly_wait(3)
            try:
                shit1=driver.find_element_by_xpath("//input[@value='37946 120198']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
