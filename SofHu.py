...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('Jiahehu2')
    driver.find_element_by_id("easpass").send_keys('606Notfound19980606')
    ...
    while True:
        driver.implicitly_wait(1.55)
        try:
            shit1=driver.find_element_by_xpath("//input[@value='47801 120188']")
            shit1.click()
