...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('zh13')
    driver.find_element_by_id("easpass").send_keys('Jackseize24hours0018')
    ...
    while True:
        ...
        if switch%9==7:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='50094 120191']")
                shit2=driver.find_element_by_xpath("//input[@value='48266 120191']")
                shit1.click()
                shit2.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
