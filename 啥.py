...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('fangziy2')
    driver.find_element_by_id("easpass").send_keys("fzUS990130")
    ...
    while True:
        if switch%2==0:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='55666 120198']")
                shit1.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
                try:
                    print('no 24 yet, trying again....')
                    switch+=1
                    driver.back()
                    driver.back()
                    driver.back()
