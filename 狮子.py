...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('hankaiq2')
    driver.find_element_by_id("easpass").send_keys('Qhk79469169')
    ...
    while True:
        if switch%2==0:
            ...
            try:
                shit3=driver.find_element_by_xpath("//input[@value='63233 120198']")
                shit3.click()
        ...
        if switch%2==1:
            ...
            try:
                shit3=driver.find_element_by_xpath("//input[@value='63234 120198']")
                shit3.click()
                driver.find_element_by_xpath("//input[@value='Register']").click()
                break
            except NoSuchElementException:
