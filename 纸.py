...
def func1():
    ...
    driver.find_element_by_id("netid").send_keys('zzhu39')
    driver.find_element_by_id("easpass").send_keys("Zhu19651229")
    ...
    while True:
            ...
            try:
                shit1=driver.find_element_by_xpath("//input[@value='31352 120191']")
                shit1.click()
